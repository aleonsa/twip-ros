#include "twip_controller/simple_controller.hpp"
    ...
    : Node(name), left_wheel_prev_pos_(0.0), right_wheel_prev_pos_(0.0), x_(0.0), y_(0.0), theta_(0.0)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/twip_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/twip_controller/odom", 10);
